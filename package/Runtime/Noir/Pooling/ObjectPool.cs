...
namespace Noir.Pooling {
    ...
    public class ObjectPool : System.IDisposable {
        ...
        /// <summary>
        /// Returns an <see cref="IEnumerable{ObjectPoolItemSystem}"/> that you can use to enumerate the active <see cref="ObjectPoolItemSystem"/> objects in the pool.
        /// </summary>
        /// <returns>An <see cref="IEnumerable{ObjectPoolItemSystem}"/> that you can use to enumerate the active <see cref="ObjectPoolItemSystem"/> objects in the pool.</returns>
        ...
        /// <returns><c>true</c> if the pool has capacity, <c>false</c> otherwise.</returns>
