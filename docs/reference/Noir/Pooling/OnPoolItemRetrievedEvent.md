...
```csharp
public sealed class OnPoolItemRetrievedEvent : MulticastDelegate, ICloneable, ISerializable
```
...
```csharp
public OnPoolItemRetrievedEvent(Object object, IntPtr method)
...
**Parameters** <br>
`objectPoolItem` [ObjectPoolItemSystem](/noir/reference//noir/reference/Noir/Pooling/ObjectPoolItemSystem.html) <br>
