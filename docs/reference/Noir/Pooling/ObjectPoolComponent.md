...
Configures an object for use with a [ObjectPoolSystem](/noir/reference//noir/reference/Noir/Pooling/ObjectPoolSystem.html).
...
<!-- tc:return_type [bool](https://learn.microsoft.com/en-us/dotnet/api/System.Boolean?view=net-7.0) -->
<!-- tc:version 1.0.0 -->
Should the [ObjectPoolSystem](/noir/reference//noir/reference/Noir/Pooling/ObjectPoolSystem.html) gameobject be the parent for spawned objects?
