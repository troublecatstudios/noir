...
The [BehaviourPoolBase<T>.OnStart](/noir/reference//noir/reference/Noir/Pooling/BehaviourPoolBase-1/#onstart) method allows derived classes to handle the event without attaching a delegate. This is the preferred technique for handling the event in a derived class.
