...
**Implements:** _[BehaviourPoolBase\<T\>](/noir/reference//noir/reference/Noir/Pooling/BehaviourPoolBase-1.html)_
...
### `GameTime`
<!-- tc:scope protected -->
<!-- tc:return_type [GameTime](/noir/reference//noir/reference/Noir/GameTime.html) -->
<!-- tc:version 1.0.0 -->
...
### `Logger`
<!-- tc:scope protected -->
<!-- tc:return_type [BehaviourLogger](/noir/reference//noir/reference/Noir/Logging/BehaviourLogger.html) -->
<!-- tc:version 1.0.0 -->
...
### `Services`
<!-- tc:scope protected -->
<!-- tc:return_type [ComponentServiceLocator](/noir/reference//noir/reference/Noir/DependencyInjection/ComponentServiceLocator.html) -->
<!-- tc:version 1.0.0 -->
...
### `CreateNewPoolItem()`
<!-- tc:scope private -->
<!-- tc:return_type [AudioSource](https://docs.unity3d.com/ScriptReference/AudioSource.html) -->
<!-- tc:version 1.0.0 -->

```csharp
protected virtual AudioSource CreateNewPoolItem()

```

### `ResetItemToDefaults(AudioSource)`
<!-- tc:scope private -->
<!-- tc:return_type [AudioSource](https://docs.unity3d.com/ScriptReference/AudioSource.html) -->
<!-- tc:version 1.0.0 -->

```csharp
protected virtual AudioSource ResetItemToDefaults(AudioSource item)

```

**Parameters** <br>
`item` [AudioSource](https://docs.unity3d.com/ScriptReference/AudioSource.html) <br>

### `OnRetrieveItemFromPool(AudioSource)`
<!-- tc:scope private -->
<!-- tc:version 1.0.0 -->

```csharp
protected virtual void OnRetrieveItemFromPool(AudioSource item)
...
### `OnReturnItemToPool(AudioSource)`
<!-- tc:scope private -->
<!-- tc:version 1.0.0 -->

```csharp
protected virtual void OnReturnItemToPool(AudioSource item)
...
### `TryGetItemFromPool(out AudioSource&)`
<!-- tc:scope public -->
<!-- tc:return_type [bool](https://learn.microsoft.com/en-us/dotnet/api/System.Boolean?view=net-7.0) -->
<!-- tc:version 1.0.0 -->

```csharp
public virtual bool TryGetItemFromPool(AudioSource& item)
...
### `ReturnItemToPool(AudioSource)`
<!-- tc:scope public -->
<!-- tc:version 1.0.0 -->

```csharp
public virtual void ReturnItemToPool(AudioSource item)
