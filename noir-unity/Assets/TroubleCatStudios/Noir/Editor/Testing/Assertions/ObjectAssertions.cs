...
namespace Noir.Testing.Assertions {
    public static class ObjectAssertions {
        public static void IsNotNull(this ICustomAssertionContext<object> context, string message = null) {
            Assert.That(context.Target, Is.Not.Null, message ?? $"Expected object to be assigned, but object was null.");
        }

        public static void IsNull(this ICustomAssertionContext<object> context, string message = null) {
            Assert.That(context.Target, Is.Null, message ?? $"Expected object to be null, but object was assigned.");
        }

        public static void IsSameAs<T>(this ICustomAssertionContext<T> context, T expectedValue, string message = null) where T : class {
